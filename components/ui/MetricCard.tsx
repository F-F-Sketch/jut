  ...
  return (
    <div ref={ref}
      ...
      style={{
        ...
        boxShadow: hovered ? '0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(237,25,102,0.1)' : 'none',
      }}>
      {/* Gradient bg */}
      <div style={{position:'absolute',top:-30,right:-30,width:100,height:100,borderRadius:'50%',background:color+'12',filter:'blur(24px)',pointerEvents:'none',transition:'opacity 0.2s',opacity:hovered?1:0.4}}/>
      {/* Shimmer on hover */}
      ...
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:16,position:'relative'}}>
        ...
        <div style={{width:36,height:36,borderRadius:10,background:color+'15',display:'flex',alignItems:'center',justifyContent:'center',border:'1px solid '+color+'20',transition:'background 0.2s',..( hovered?{background:color+'25'}:{})}}>
