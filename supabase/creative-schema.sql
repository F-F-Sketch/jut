-- ============================================================
-- JUT — Creative Intelligence Schema
...
CREATE TABLE IF NOT EXISTS creative_enhancements (
  ...
  enhanced_asset_url  TEXT,
  improvement_summary JSONB DEFAULT '[]',
  score_delta         JSONB DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS creative_variants (
  ...
  analysis_id    UUID REFERENCES creative_analyses(id),
